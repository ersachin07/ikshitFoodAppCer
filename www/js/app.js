			    ...
			    case "getLanguageSettings":   			       		      
			       ...
			       var options = {
					 ...
					 var options2 = {
					  ...
					  if(getStorage("IntroScreenCheck")){
				      kSettingsNavigator.resetToPage("slidingMenu.html", options);							 
					  }else{
            kSettingsNavigator.resetToPage("page1.html", options2);	
					  }
...
/// changes done by paras for browse restaurant.........................................
...
{	
    ...
    $.each( data, function( key, val ) {     
    	 ...
    	 //dump(val);
			...
			//  htm+='<ons-list-item modifier="tappable" class="list-item-container dotted-spaced" style="border-bottom:1px dotted #cb202d; padding-top:15px;padding-bottom:15px; " onclick="loadRestaurantCategory('+val.merchant_id+');" >';
			// htm+='<ons-list-item modifier="tappable" class="list-item-container " style="padding-top:15px;padding-bottom:15px;  background-image: linear-gradient(to right, red 20%, rgba(255, 255, 255, 0) 0%);			background-position: bottom; 			background-size: 10px 2px; 			background-repeat: repeat-x; " onclick="loadRestaurantCategory('+val.merchant_id+');" >';     	 
			htm+='<ons-list-item modifier="tappable" class="list-item-container " style="padding-top:0px;padding-bottom:0px;  background-image: linear-gradient(to right, red 20%, rgba(255, 255, 255, 0) 0%);			background-position: bottom; 			background-size: 10px 2px; 			background-repeat: repeat-x; " onclick="loadRestaurantCategory('+val.merchant_id+');" >';     	 
			//htm+='<ons-row class="row" onclick="loadRestaurantCategory('+val.merchant_id+');" >';    	 
			 htm+='<ons-row class="row" >';    	
			  
    	     htm+='<ons-col class="col-image border" width="25%" style="padding-right:20px;">';  //column start here
    	          ...
    	          dump(val.services);
								...
								// //this is delivery and pickup services 
    	          ...
    	          // }
								...
								// //this is cash on delivery  available
    	     ...
    	     htm+='</ons-col>';//column ends here
					 
					 //second column start here 
    	     htm+='<ons-col class="col-description border" width="45%">';
								 htm+='<div>';
								 //this is rating in stars.
	    	          //  htm+='<div class="rating-stars" data-score="'+val.ratings.ratings+'"></div>';
									 htm+='<p class="restauran-title concat-text" style="color:#cb202d;font-weight: bold;   font-size:medium;">'+val.restaurant_name+'</p>';
									 //this is cuisine - i think it iDiner,healthyk,pizza
	    	           htm+='<p class="concat-textx" style="font-size:x-small;">'+val.cuisine+'</p>';
									 
									 //this is distance delivery distance : 5 kilometers
	    	           if(!empty(val.distance)){
	    	           	   htm+='<p style="font-size:x-small;">'+val.distance+'</p>';
	    	           }
									 
									 //this is delivery Est: 40 mins
	    	           //if(val.service!=3){
	    	           if(val.service==1 || val.service==2 || val.service==4 || val.service==5 ){
	    	           	   if(!empty(val.delivery_estimation)){
	    	           	      htm+='<p style="font-size:x-small;">'+val.delivery_estimation+'</p>';	    	           	   
	    	           	   }
	    	           	   if(!empty(val.delivery_distance)){
	    	           	      htm+='<p style="font-size:x-small;">'+val.delivery_distance+'</p>';
	    	           	   }
	    	           }
	    	           
	    	
									  //this is OPen red button.
						// htm+='<span class="notification right'+val.tag_raw+' " style="background:#5BA829;">'+val.is_open+'</span><br>';
						
						// htm+='<p class="right" style="width:100%; margin:0px;"><span class="notification '+val.tag_raw+' " style="background:#5BA829; margin:0px;">'+val.is_open+'</span></p>';
						htm+='<span class="notification '+val.tag_raw+' " style="background:#5BA829; margin:0px; font-size:x-small; ">'+val.is_open+'</span>';
						
	    	          //  //this is OPen red button.
	    	          //  htm+='<span class="notification '+val.tag_raw+' " style="background:#CDD614;">'+val.is_open+'</span>';
	    	           
	    	           if (val.is_sponsored==2){
	    	           	  htm+='<span class="notification sponsored" style="font-size:x-small;">'+ getTrans("Sponsored",'sponsored') +'</span>';
	    	           }
	    	           
    	           htm+='</div>';
    	           //with in second colmun this is a new row.
    	           /////////////htm+='<ons-row>';
    	              
    	           //////////htm+='</ons-row>';//2nd column's 2nd row ends here.
    	           
					 htm+='</ons-col>';//second column ends here
					 //3rd columns starts here
					 
					//  htm+='<ons-col class="col-description border " width="30%">';
					htm+='<ons-col   " width="30%">';
					 htm+='<div class="rating-stars " style="margin-top:0px; margin-bottom:0px; margin-right:0px; margin-left:0px; padding:0px;" data-score="'+val.ratings.ratings+'"></div>';
    	          ...
    	          if(!empty(val.payment_available)){ 
    	          	 if(val.payment_available.length>0){
										 $.each( val.payment_available, function( key_pv, val_pv ) 
										 {
												htm+='<p class="right " style="font-size:small;">'+val_pv+'</p>';
						    	 	});	
    	          	 }
								}
								//this is delivery and pickup services 
				...
				{    	          	
							$.each( val.services, function( key_service, val_services ) 
							{
									htm+='<p class="right  " style="margin:0px; font-size:small; padding:0px;">'+val_services+' <i class="green-color ion-android-checkmark-circle" style="margin:0px;"></i></p>';
			 ...
			 htm+='</ons-row>';//ist row ends here.
			 

			 htm+='<ons-row class="row" style="margin-top:0px; margin-bottom:0px;  padding-top:0px; padding-bottom:0px;" >';
					htm+='<ons-col   " style="margin-top:0px; margin-bottom:0px;  padding-top:0px; padding-bottom:0px;">';
					if ( val.offers.length>0){
						$.each( val.offers, function( key_offer, val_offer ) 
						{
							//this is Free Delivery on orders over rs 500.00 
								htm+='<p class="top10" style="color:#099e44;">'+val_offer+'</p>';
						});
			 }
					htm+='</ons-col>';//column ends here
			 htm+='</ons-row>';//ist row ends here.
			 ...
			 htm+='<ons-row class="row" style="margin-top:0px; margin-bottom:0px;  padding-top:0px; padding-bottom:0px;" >';
					...
					if(val.service==1 || val.service==2 || val.service==4 || val.service==5 )
					{
						htm+='<ons-col  style="margin:0px; padding:0px;">';
						//this is just Delivery label 
						htm+='<p class="trn" data-trn-key="delivery" style="margin:0px; padding:5px; font-weight:bold;">Delivery : ';
						
						if(!empty(val.delivery_fee))
						{
							//this is delviery Fees.
							//  htm+='<price style="margin-top:0px; margin-bottom:0px;  padding-top:0px; padding-bottom:0px;">'+val.delivery_fee+'</price>';
							//htm+='<p style="margin-top:0px; margin-bottom:0px;  padding-top:0px; padding-bottom:0px; font-weight:bold; font-size:x-small;">'+val.delivery_fee+'</p>';
							
							htm+=val.delivery_fee;
						}
						htm+='</p>';
						htm+='</ons-col>';//here ist row - > second -column - mai second row ka ist column ends here 
					}
			 
			 
			 if (!empty(val.minimum_order)){
			 htm+='<ons-col class="border-left" style="margin:0px; padding:0px; ">';
			 //this is min. order in second colmun of second row inside second column.
					 //htm+='<p class="trn" data-trn-key="min_order" style="margin:0px; padding:0px; ">Min. Order</p>';
					 htm+='<p class="trn" data-trn-key="min_order" style="margin:0px; padding:5px; font-weight:bold;">Min. Order : ';
					//  htm+='<price style="margin:0px; padding:0px;">'+val.minimum_order+'</price>';
					// htm+='<p style="margin:0px; padding:0px; font-weight:bold;">'+val.minimum_order+'</p>';
					htm+=val.minimum_order+'</p>';
			 htm+='</ons-col>';//2nd row ka 2nd column end here
			 }
...
function callFirstPage(){
 ...
 //kSettingsNavigator.pushPage("slidingMenu.html", options);	
 kSettingsNavigator.resetToPage("page1.html", options);
}
...
function callSecondPage(){
 ...
 //kSettingsNavigator.pushPage("slidingMenu.html", options);	
 kSettingsNavigator.resetToPage("page2.html", options);
}
...
function callThirdPage(){
 ...
 //kSettingsNavigator.pushPage("slidingMenu.html", options);	
 kSettingsNavigator.resetToPage("page3.html", options);	
}

function callForthPage(){
	var options = {
		animation: 'slide',
		onTransitionEnd: function() { 		
			 //initSlideMenu();						      	 
 ...
 //kSettingsNavigator.pushPage("slidingMenu.html", options);	
 kSettingsNavigator.resetToPage("page4.html", options);
}
...
function callHomePage(){
 ...
 //kSettingsNavigator.pushPage("slidingMenu.html", options);
 setStorage("IntroScreenCheck",true);	
 kSettingsNavigator.resetToPage("slidingMenu.html", options);	
}
...
//START fun display item by category 
...
actions='"loadItemDetails('+ "'"+val.item_id+"'," +  "'"+data.merchant_id+"'," + "'"+data.cat_id+"'"  +');"';
         ...
         html+='<ons-row class="row" onclick="loadItemDetails('+ "'"+val.item_id+"'," +  "'"+data.merchant_id+"'," + "'"+data.cat_id+"'"  +');" >';
         ...
         if ( data.mobile_menu==1){
         	...
         	html+='<ons-col class="col-image" width="50%">';

                html+='<p style="color:red !important;" class="restauran-title concat-text">'+val.item_name+'</p>';
             ...
             html+='</ons-col>';
				...
				//sanchit latest code 27-3-2019
             html+='<ons-col class="col-image text-right" width="30%">';
              ...
              if ( val.prices.length>0){
	                ...
	                $.each( val.prices, function( key_price, price ) { 
	                   ...
	                   if (!empty(price.price_discount_pretty)){
	                   	   ...
	                   	   html+='<p class="p-small" style="color:red !important;">'+price.size+' <price class="discount">'+price.price_pretty+'</price>'; 
	                   	   ...
	                   	   html+='<p style="color:red !important;" class="p-small">'+price.size+' <price>'+price.price_pretty+'</price></p>';
			 ...
			 html+='</ons-col>';
			  ...
			  html+='<ons-col class="col-image text-right" width="20%">';
html+='<button style="background:#fff;float:right;color:green;border-radius:10px;border:1px solid green;font-size:16px;">Add +</button>';
             ...
             html+='<ons-col class="col-image" width="35%">';
                ...
                html+='<div class="logo-wrap2" >';
                  ...
                  html+='<img style="width:100%;height:100%;" src="'+val.photo+'" />';
                ...
                if ( val.prices.length>0){
	                ...
	                $.each( val.prices, function( key_price, price ) { 
	                   ...
	                   if (!empty(price.price_discount_pretty)){
	                   	   ...
	                   	   html+='<p class="p-small" style="color:red !important;">'+price.size+' <price>'+price.price_pretty+'</price></p>';
...
//End fun display item by category 
...
{		
	...
	if ( data.has_price==2){	
		...
		htm+='<ons-list-header style="background-color: #cb202d;color:#fff;" class="list-header trn" data-trn-key="price">Price</ons-list-header>';
		var x=0
	...
	if (!empty(data.cooking_ref)){
		// htm+='<ons-list-header class="list-header trn" data-trn-key="cooking_ref">Cooking Preference</ons-list-header>';
		   htm+='<ons-list-header style="background-color: #cb202d;color:#fff;" class="list-header trn" data-trn-key="cooking_ref">Cooking Preference</ons-list-header>';
	...
	if (!empty(data.ingredients)){
		// htm+='<ons-list-header class="list-header trn" data-trn-key="ingredients">Ingredients</ons-list-header>';
		   htm+='<ons-list-header style="background-color: #cb202d;color:#fff;" class="list-header trn" data-trn-key="ingredients">Ingredients</ons-list-header>';
	...
	if (!empty(data.addon_item)){
		$.each( data.addon_item, function( key, val ) { 
			...
			htm+='<ons-list-header style="background-color: #cb202d;color:#fff;" class="list-header require_addon_'+val.subcat_id+' ">'+val.subcat_name+'</ons-list-header>';
...
{	
	...
	htm+='<ons-list-header style="color:white;" class="trn pumpkinBG" data-trn-key="delivery_options">Delivery Options</ons-list-header>';
...
function showMerchantInfo(data)
{
	...
	$("#page-merchantinfo h3").html(data.merchant_info.restaurant_name).css({"color":"white"});
	...
	if (!empty(data.payment_method)){
		...
		p+= '<ons-list-header modifier="inset" class="center trn " data-trn-key="payment_methods" style="height:30px; font-size: 20px; margin-top:18px; border:1px solid grey; background:#cb202d;color:white;">Payment Methods</ons-list-header>'
...
//Start function getCategory(index)
		   	   ...
		   	   if (app_version>="2.4"){
		   	   	   if(data.details.show_cat_image==1){
		   	   	   	  $.each( data.details.data, function( key, val ) {
								   //sanchit code change 27-3-2019
		   	   	   	  	 html+= '<ons-list-item class="main-menu-list-with-border" modifier="chevron" onclick="loadmenu('+val.cat_id+','+val.merchant_id+');"  >';			   	   	   
                             html+= '<ons-row align="center">';
                               html+= '<ons-col class="col-image" width="70px">';
                                 html+='<img class="rounded_image" src="'+ val.photo_url +'">';
                               html+= '</ons-col>';
                               
                               html+= '<ons-col>';
                               html+='<p style="font-size:20px;" class="white nomargin">'+val.category_name;+'</p>'; 
                               html+= '<p class=" white small nomargin">'+val.category_description+'</p>';
                             ...
                             html+= '</ons-row>';
		   	   	   	 ...
		   	   	   	 $.each( data.details.data, function( key, val ) {
							 html+= '<ons-list-item modifier="chevron"  class="main-menu-list-with-border"  onclick="loadmenu('+val.cat_id+','+val.merchant_id+');"  >';			
							 html+= '<ons-icon icon="fa fa-food" class="list-item__icon" style="margin-right:20px;"></ons-icon>'      	   
...
//End function getCategory(index)
